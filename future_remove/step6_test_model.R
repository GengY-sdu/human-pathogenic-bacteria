...
load("pathogen/future_remove/rffuncs_future_terra_nohuman.rdata")
...
write.csv(plot_train,file = 'pathogen/future_remove/train_future_set.csv',row.names = F)
fit2 <- custom
...
write.csv(plot_test,file = 'pathogen/future_remove/test_future_set.csv',row.names = F)
