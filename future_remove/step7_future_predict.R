...
load(file = "pathogen/future_remove/rffuncs_future_terra_nohuman.rdata")
optvar <- rfFuncs$optVariables
max(rfFuncs$results$Rsquared)

set.seed(51)
load(file = 'pathogen/future_remove/inTrain.Rdata')
load(file = 'pathogen/future_remove/inTest.Rdata')
...
load(file = "pathogen/future_remove/custom_nohuman.rdata")
fit2 <- custom
...
dat_mess <- fread("pathogen/future_remove/MESS_table_nohuman.csv")
...
fwrite(result,"pathogen/future_remove/ssp126_nohuman.csv")
result <- result[,c(2,3,21)]

result <- fread(file = 'pathogen/future_remove/ssp126_nohuman.csv')
...
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_remove/ssp126_lat.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_remove/ssp245_nohuman.csv")
result <- result[,c(2,3,19)]

result <- fread(file = 'pathogen/future_remove/ssp245_nohuman.csv')
result <- result[,c(2,3,4,18,19)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_remove/ssp245_lat.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_remove/ssp370_nohuman.csv")
result <- result[,c(2,3,18)]

result <- fread(file = 'pathogen/future_remove/ssp370_nohuman.csv')
result <- result[,c(2,3,4,17,18)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_remove/ssp370_lat.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_remove/ssp585_nohuman.csv")
result <- result[,c(2,3,19)]

result <- fread(file = 'pathogen/future_remove/ssp585_nohuman.csv')
result <- result[,c(2,3,4,18,19)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_remove/ssp585_lat.csv',row.names = F)

#step7.5:final##################################################################

rm(list = ls())
ssp126 <- fread("pathogen/future_remove/ssp126_nohuman.csv")
ssp245 <- fread("pathogen/future_remove/ssp245_nohuman.csv")
ssp370 <- fread("pathogen/future_remove/ssp370_nohuman.csv")
ssp585 <- fread("pathogen/future_remove/ssp585_nohuman.csv")
...
write.csv(total,file = 'pathogen/future_remove/future_final.csv',row.names = F)
