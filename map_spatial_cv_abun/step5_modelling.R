...
load("pathogen/map_spatial_cv_abun/HPB-1500_abun.Rdata")
...
control_grid <- trainControl(index = lapply(sb1$folds_list, function(x) x[[1]]),indexOut = lapply(sb1$folds_list, function(x) x[[2]]),search='grid',savePredictions = 'final',allowParallel = T)
rfmodel2 <- train(trainx,trainy, method='rf',tuneGrid=rf_gridsearch$bestTune, 
                  ntree= 1500, trControl=control_grid, 
...
mapset <- read.csv(file = 'pathogen/map_spatial_cv_abun/map_cv_abun.csv')
...
write.csv(predictsum,file = 'pathogen/map_spatial_cv_abun/map_set_cv_abun.csv')
...
write.csv(var1,file = 'pathogen/map_spatial_cv_abun/importance_model1_cv_abun.csv')
write.csv(var2,file = 'pathogen/map_spatial_cv_abun/importance_model2_cv_abun.csv')
write.csv(var3,file = 'pathogen/map_spatial_cv_abun/importance_model3_cv_abun.csv')
write.csv(var4,file = 'pathogen/map_spatial_cv_abun/importance_model4_cv_abun.csv')
write.csv(var5,file = 'pathogen/map_spatial_cv_abun/importance_model5_cv_abun.csv')
write.csv(var6,file = 'pathogen/map_spatial_cv_abun/importance_model6_cv_abun.csv')
write.csv(var7,file = 'pathogen/map_spatial_cv_abun/importance_model7_cv_abun.csv')
write.csv(var8,file = 'pathogen/map_spatial_cv_abun/importance_model8_cv_abun.csv')
write.csv(var9,file = 'pathogen/map_spatial_cv_abun/importance_model9_cv_abun.csv')
write.csv(var10,file = 'pathogen/map_spatial_cv_abun/importance_model10_cv_abun.csv')
