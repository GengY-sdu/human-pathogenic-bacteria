...
mapset <- read.csv(file = 'pathogen/map_remove/remove_map.csv')
...
write.csv(predictsum,file = 'pathogen/map_remove/map_remove.csv')
...
write.csv(var1,file = 'pathogen/map_remove/importance_model1_set.csv')
write.csv(var2,file = 'pathogen/map_remove/importance_model2_set.csv')
write.csv(var3,file = 'pathogen/map_remove/importance_model3_set.csv')
write.csv(var4,file = 'pathogen/map_remove/importance_model4_set.csv')
write.csv(var5,file = 'pathogen/map_remove/importance_model5_set.csv')
write.csv(var6,file = 'pathogen/map_remove/importance_model6_set.csv')
write.csv(var7,file = 'pathogen/map_remove/importance_model7_set.csv')
write.csv(var8,file = 'pathogen/map_remove/importance_model8_set.csv')
write.csv(var9,file = 'pathogen/map_remove/importance_model9_set.csv')
write.csv(var10,file = 'pathogen/map_remove/importance_model10_set.csv')
