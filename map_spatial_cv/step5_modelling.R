...
load(file = 'pathogen/map_spatial_cv/sb1.Rdata')
...
rfmodel2 <- train(trainx,trainy, method='rf',tuneGrid=rf_gridsearch$bestTune, 
                  ntree= 1200, trControl=control_grid, 
...
mapset <- read.csv(file = 'pathogen/map_spatial_cv/map_cv.csv')
...
write.csv(predictsum,file = 'pathogen/map_spatial_cv/map_set_cv.csv')
...
write.csv(var1,file = 'pathogen/map_spatial_cv/importance_model1_cv.csv')
write.csv(var2,file = 'pathogen/map_spatial_cv/importance_model2_cv.csv')
write.csv(var3,file = 'pathogen/map_spatial_cv/importance_model3_cv.csv')
write.csv(var4,file = 'pathogen/map_spatial_cv/importance_model4_cv.csv')
write.csv(var5,file = 'pathogen/map_spatial_cv/importance_model5_cv.csv')
write.csv(var6,file = 'pathogen/map_spatial_cv/importance_model6_cv.csv')
write.csv(var7,file = 'pathogen/map_spatial_cv/importance_model7_cv.csv')
write.csv(var8,file = 'pathogen/map_spatial_cv/importance_model8_cv.csv')
write.csv(var9,file = 'pathogen/map_spatial_cv/importance_model9_cv.csv')
write.csv(var10,file = 'pathogen/map_spatial_cv/importance_model10_cv.csv')
