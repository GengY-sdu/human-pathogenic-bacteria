...
save(inTrain,file = 'pathogen/future_spatial_cv_abun/inTrain.Rdata')
...
set.seed(i)
load(file = 'pathogen/future_spatial_cv_abun/location.Rdata')
...
save(sb1,file = 'pathogen/future_spatial_cv_abun/sb1.Rdata')
...
stopCluster(cl)
save(rfFuncs,file = "pathogen/future_spatial_cv_abun/rffuncs_future_terra_nohuman_abun.rdata")
