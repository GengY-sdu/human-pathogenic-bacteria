...
load(file = "pathogen/future_EMP/custom_nohuman.rdata")
fit2 <- custom
...
current_data$mess <- NA
current_data <- current_data[,c(4,1,2,3,5)]
gc()
...
fwrite(result,"pathogen/future_EMP/ssp126_nohuman.csv")
result <- result[,c(2,3,21)]

result <- fread(file = 'pathogen/future_EMP/ssp126_nohuman.csv')
...
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_EMP/ssp126_lat.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_EMP/ssp245_nohuman.csv")
result <- result[,c(2,3,19)]

result <- fread(file = 'pathogen/future_EMP/ssp245_nohuman.csv')
result <- result[,c(2,3,4,18,19)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_EMP/ssp245_lat.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_EMP/ssp370_nohuman.csv")
result <- result[,c(2,3,18)]

result <- fread(file = 'pathogen/future_EMP/ssp370_nohuman.csv')
result <- result[,c(2,3,4,17,18)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_EMP/ssp370_lat.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_EMP/ssp585_nohuman.csv")
result <- result[,c(2,3,19)]

result <- fread(file = 'pathogen/future_EMP/ssp585_nohuman.csv')
result <- result[,c(2,3,4,18,19)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_EMP/ssp585_lat.csv',row.names = F)

#step6.5:final##################################################################

rm(list = ls())
ssp126 <- fread("pathogen/future_EMP/ssp126_nohuman.csv")
ssp245 <- fread("pathogen/future_EMP/ssp245_nohuman.csv")
ssp370 <- fread("pathogen/future_EMP/ssp370_nohuman.csv")
ssp585 <- fread("pathogen/future_EMP/ssp585_nohuman.csv")
...
write.csv(total,file = 'pathogen/future_EMP/future_final.csv',row.names = F)
