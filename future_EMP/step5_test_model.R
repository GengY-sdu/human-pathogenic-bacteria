...
load("pathogen/future_EMP/rffuncs_future_terra_nohuman.rdata")
...
write.csv(plot_train,file = 'pathogen/future_EMP/train_future_set.csv',row.names = F)
fit2 <- custom
...
write.csv(plot_test,file = 'pathogen/future_EMP/test_future_set.csv',row.names = F)
