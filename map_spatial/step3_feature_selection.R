...
save(inTrain,file = 'pathogen/map_spatial/inTrain.Rdata')
save(inTest,file = 'pathogen/map_spatial/inTest.Rdata')
trainx <- x[inTrain, ]
testx <- x[inTest, ]
...
stopCluster(cl)
save(rfFuncs,file = 'pathogen/map_spatial/rfFuncs.Rdata')
...
save(optvar,file = 'pathogen/map_spatial/optvar.Rdata')
write.csv(sum,file = 'pathogen/map_spatial/feature_set.csv',row.names = F)
