...
set.seed(51)
load(file = 'pathogen/map_spatial/optvar.Rdata')
load(file = 'pathogen/map_spatial/ml_df.Rdata')
dat <- df_filter
dat2 <- na.omit(dat)
dat3 <- dat2[,-1]
x <- dat3[,optvar]  
...
load(file = 'pathogen/map_spatial/inTrain.Rdata')
load(file = 'pathogen/map_spatial/inTest.Rdata')
trainx <- x[inTrain, ]
testx <- x[inTest, ]
trainy <- logBBB[inTrain]
testy <- logBBB[inTest]

load("pathogen/map_spatial/HPB-2500.Rdata")
...
mapset <- read.csv(file = 'pathogen/map_spatial/map.csv')
...
write.csv(predictsum,file = 'pathogen/map_spatial/map_set.csv')
...
write.csv(var1,file = 'pathogen/map_spatial/importance_model1_set.csv')
write.csv(var2,file = 'pathogen/map_spatial/importance_model2_set.csv')
write.csv(var3,file = 'pathogen/map_spatial/importance_model3_set.csv')
write.csv(var4,file = 'pathogen/map_spatial/importance_model4_set.csv')
write.csv(var5,file = 'pathogen/map_spatial/importance_model5_set.csv')
write.csv(var6,file = 'pathogen/map_spatial/importance_model6_set.csv')
write.csv(var7,file = 'pathogen/map_spatial/importance_model7_set.csv')
write.csv(var8,file = 'pathogen/map_spatial/importance_model8_set.csv')
write.csv(var9,file = 'pathogen/map_spatial/importance_model9_set.csv')
write.csv(var10,file = 'pathogen/map_spatial/importance_model10_set.csv')
