...
set.seed(51)
load(file = 'pathogen/future_spatial/location.Rdata')
points <- location
...
save(inTrain,file = 'pathogen/future_spatial/inTrain.Rdata')
save(inTest,file = 'pathogen/future_spatial/inTest.Rdata')
...
stopCluster(cl)
save(rfFuncs,file = "pathogen/future_spatial/rffuncs_future_terra_nohuman.rdata")
