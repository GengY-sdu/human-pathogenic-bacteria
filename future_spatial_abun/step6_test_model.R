...
load("pathogen/future_spatial_abun/rffuncs_future_terra_nohuman_abun.rdata")
...
write.csv(plot_train,file = 'pathogen/future_spatial_abun/train_future_set_abun.csv',row.names = F)
fit2 <- custom
...
write.csv(plot_test,file = 'pathogen/future_spatial_abun/test_future_set_abun.csv',row.names = F)
