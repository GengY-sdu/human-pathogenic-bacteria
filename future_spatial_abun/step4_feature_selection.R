...
set.seed(51)
load(file = 'pathogen/future_spatial_abun/location.Rdata')
points <- location
...
save(inTrain,file = 'pathogen/future_spatial_abun/inTrain.Rdata')
save(inTest,file = 'pathogen/future_spatial_abun/inTest.Rdata')
...
stopCluster(cl)
save(rfFuncs,file = "pathogen/future_spatial_abun/rffuncs_future_terra_nohuman_abun.rdata")
