...
save(location,file = 'pathogen/future_spatial_abun/location.Rdata')
history_dataset <- history_dataset[,-c(1:2)]
MESS_dat <- history_dataset[,-1]
save(MESS_dat,file = 'pathogen/future_spatial_abun/MESS_dat.Rdata')
...
save(history_dataset,file = 'pathogen/future_spatial_abun/history_dataset_nohuman_abun.Rdata')
