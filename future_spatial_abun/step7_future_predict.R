...
load(file = "pathogen/future_spatial_abun/rffuncs_future_terra_nohuman_abun.rdata")
optvar <- rfFuncs$optVariables
max(rfFuncs$results$Rsquared)

set.seed(51)
load(file = 'pathogen/future_spatial_abun/inTrain.Rdata')
load(file = 'pathogen/future_spatial_abun/inTest.Rdata')
...
load(file = "pathogen/future_spatial_abun/custom_nohuman_abun.rdata")
fit2 <- custom
...
dat_mess <- fread("pathogen/future_spatial_abun/MESS_table_nohuman_abun.csv")
...
fwrite(result,"pathogen/future_spatial_abun/ssp126_nohuman_abun.csv")
result <- result[,c(2,3,21)]

result <- fread(file = 'pathogen/future_spatial_abun/ssp126_nohuman_abun.csv')
...
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_spatial_abun/ssp126_lat_abun.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_spatial_abun/ssp245_nohuman_abun.csv")
result <- result[,c(2,3,19)]

result <- fread(file = 'pathogen/future_spatial_abun/ssp245_nohuman_abun.csv')
result <- result[,c(2,3,4,18,19)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_spatial_abun/ssp245_lat_abun.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_spatial_abun/ssp370_nohuman_abun.csv")
result <- result[,c(2,3,18)]

result <- fread(file = 'pathogen/future_spatial_abun/ssp370_nohuman_abun.csv')
result <- result[,c(2,3,4,17,18)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_spatial_abun/ssp370_lat_abun.csv',row.names = F)
...
result$'respone_chage' <- (result$average - result$current_pred)/result$current_pred
fwrite(result,"pathogen/future_spatial_abun/ssp585_nohuman_abun.csv")
result <- result[,c(2,3,19)]

result <- fread(file = 'pathogen/future_spatial_abun/ssp585_nohuman_abun.csv')
result <- result[,c(2,3,4,18,19)]
(sum(result$average)-sum(result$current_pred))/sum(result$current_pred)
dat2 <- result[,"lat_mean":=((sum(average)-sum(current_pred))/sum(current_pred)),by =c("y")]
dat2 <- unique(dat2,by = c("y"))
setorder(dat2, y)
write.csv(dat2,file = 'pathogen/future_spatial_abun/ssp585_lat_abun.csv',row.names = F)

#step7.5:final##################################################################

rm(list = ls())
ssp126 <- fread("pathogen/future_spatial_abun/ssp126_nohuman_abun.csv")
ssp245 <- fread("pathogen/future_spatial_abun/ssp245_nohuman_abun.csv")
ssp370 <- fread("pathogen/future_spatial_abun/ssp370_nohuman_abun.csv")
ssp585 <- fread("pathogen/future_spatial_abun/ssp585_nohuman_abun.csv")
...
write.csv(total,file = 'pathogen/future_spatial_abun/future_final_abun.csv',row.names = F)
