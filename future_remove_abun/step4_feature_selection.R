...
set.seed(51)
load(file = 'pathogen/future_remove_abun/loactaion.Rdata')
points <- loactaion
...
save(inTrain,file = 'pathogen/future_remove_abun/inTrain.Rdata')
save(inTest,file = 'pathogen/future_remove_abun/inTest.Rdata')
...
stopCluster(cl)
save(rfFuncs,file = "pathogen/future_remove_abun/rffuncs_future_terra_nohuman_abun.rdata")
