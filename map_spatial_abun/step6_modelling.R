...
mapset <- read.csv(file = 'pathogen/map_spatial_abun/map_abun.csv')
...
write.csv(predictsum,file = 'pathogen/map_spatial_abun/map_set_abun.csv')
...
write.csv(var1,file = 'pathogen/map_spatial_abun/importance_model1_set_abun.csv')
write.csv(var2,file = 'pathogen/map_spatial_abun/importance_model2_set_abun.csv')
write.csv(var3,file = 'pathogen/map_spatial_abun/importance_model3_set_abun.csv')
write.csv(var4,file = 'pathogen/map_spatial_abun/importance_model4_set_abun.csv')
write.csv(var5,file = 'pathogen/map_spatial_abun/importance_model5_set_abun.csv')
write.csv(var6,file = 'pathogen/map_spatial_abun/importance_model6_set_abun.csv')
write.csv(var7,file = 'pathogen/map_spatial_abun/importance_model7_set_abun.csv')
write.csv(var8,file = 'pathogen/map_spatial_abun/importance_model8_set_abun.csv')
write.csv(var9,file = 'pathogen/map_spatial_abun/importance_model9_set_abun.csv')
write.csv(var10,file = 'pathogen/map_spatial_abun/importance_model10_set_abun.csv')
